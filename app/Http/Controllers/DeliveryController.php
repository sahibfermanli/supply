...
class DeliveryController extends HomeController
{
    ...
    public function get_delivered_for_supply() {
        ...
        return view('backend.delivered_orders')->with(['purchases'=>$purchases, 'departments'=>$departments, 'statuses'=>$situations, 'sellers'=>$sellers, 'warehousemen'=>$warehousemen, 'search_arr'=>$search_arr]);
    }
    ...
    public function get_delivered_for_users() {
        ...
        return view('backend.delivered_orders')->with(['purchases'=>$purchases, 'statuses'=>$situations, 'sellers'=>$sellers, 'warehousemen'=>$warehousemen, 'search_arr'=>$search_arr]);
    }
    ...
    public function get_delivered_for_warehouseman() {
        ...
        return view('backend.delivered_orders')->with(['purchases'=>$purchases, 'departments'=>$departments, 'statuses'=>$situations, 'sellers'=>$sellers, 'search_arr'=>$search_arr]);
    }
