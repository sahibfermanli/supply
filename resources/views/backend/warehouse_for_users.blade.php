...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function search_data() {
            ...
            var link = '?product=' + product + '&brand=' + brand + '&model=' + model + '&category=' + category + '&warehouseman=' + warehouseman + '&vehicle=' + vehicle + '&status=' + status + '&start_date=' + start_date + '&end_date=' + end_date;
