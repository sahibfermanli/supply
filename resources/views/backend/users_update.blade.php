        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Şəxsi məlumatların dəyişdirilməsi</h3>
                </div>
            </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <form id="form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
                                {{csrf_field()}}
                                {{Form::bsTextRequired('name', 'Name', Auth::user()->name)}}
                                {{Form::bsTextRequired('surname', 'Surname', Auth::user()->surname)}}
                                {{Form::bsEmailRequired('email', 'E-mail', Auth::user()->email)}}
