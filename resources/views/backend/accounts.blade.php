...
@section('content')
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr class="jsgrid-filter-row" style="display: none;" id="account-add-form">
                                        ...
                                        <td id="orders-add-inputs" ><input type="text" class="form-control input-sm" name="company" placeholder="Şirkət *"></td>
                                    ...
                                    @foreach($accounts as $account)
                                        ...
                                        <tr class="even pointer" id="row_{{$row}}">
                                            ...
                                            <td><input style="border: none;" type="text" class="form-control input-sm" id="company_edit_{{$account->id}}" value="{{$account->company}}"></td>
                                            <td>{{$account_date}}</td>
                                            <td>
                                                <center>
                                            ...
                                            <td>
                                                <span class="btn btn-danger btn-xs" onclick="del(this, '{{$account->id}}', '{{$row}}');"><i class="fa fa-trash-o"></i></span>
                                                <span class="btn btn-warning btn-xs" onclick="update(this, '{{$account->id}}');"><i class="fa fa-edit"></i></span>
                                            </td>
                                        </tr>
                                        @php
                                            $row++;
    ...
    <div class="modal fade" id="select-purchases-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
@section('js')
    ...
    <script type="text/javascript">
        //add modal-orders
        $(document).on('click', '.select-purchases-modal', function() {
            $('#select-purchases-modal').modal('show');
        });
    </script>
    ...
    <script>
        ...
        function update(e, id) {
            swal({
                ...
                if (result.value) {
                    ...
                    var company = $('#company_edit_'+id).val();
        ...
        function get_purchases(e, account_id) {
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                type: "Post",
                url: '',
